...
{
   QMessageBox::information( NULL, QString("Maverick 3D"), QString::fromUtf8(str), QMessageBox::Ok, 0 );
}

extern "C" void msgqt_warning( const char * str )
{
   QMessageBox::warning( NULL, QString("Maverick 3D"), QString::fromUtf8(str), QMessageBox::Ok, 0 );
}

extern "C" void msgqt_error( const char * str )
{
   QMessageBox::critical( NULL, QString("Maverick 3D"), QString::fromUtf8(str), QMessageBox::Ok, 0 );
}
...
static char _msgqt_info_common( MessageType type, const QString & str, const char * opts )
{
   ...
   {
      case MsgError:
         result = QMessageBox::critical( NULL, QString("Maverick 3D"), str, button[0], button[1], button[2] );
         break;
      case MsgWarning:
         result = QMessageBox::warning( NULL, QString("Maverick 3D"), str, button[0], button[1], button[2] );
         break;
      case MsgInfo:
      default:
         result = QMessageBox::information( NULL, QString("Maverick 3D"), str, button[0], button[1], button[2] );
         break;
   }
